...
BaseSettingsModel = Backbone.Model.extend({
  ...
  removeDataDefaults: function removeDataDefaults(data, controls) {
    ...
    var onlyHardCodedDefaults = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    jQuery.each(data, function (key) {
      ...
      var defaultValue = onlyHardCodedDefaults && control.hasOwnProperty('hardcoded_default') ? control.hardcoded_default : control.default;

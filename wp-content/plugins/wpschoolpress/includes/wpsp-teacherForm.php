                     ...
                     ?>
                        <div class="wpsp-col-lg-3 wpsp-col-md-4 wpsp-col-sm-4 wpsp-col-xs-12">
                            <div class="wpsp-form-group">
                                ...
                                <div class="wpsp-profileUp"><?php $turl = WPSP_PLUGIN_URL . 'img/default_avtar.jpg';?>
                        ...
                        <div class="wpsp-col-xs-12">
                            <div class="wpsp-form-group">
                                <label class="wpsp-label" for="Address">
                                  <?php esc_html_e("Street Address ","wpschoolpress");
                                      /*Check Required Field*/
                        ...
                        <div class="wpsp-col-md-4 wpsp-col-sm-4 wpsp-col-xs-12">
                            <div class="wpsp-form-group">
                                ...
                                <select data-is_required="<?php echo esc_attr($is_required); ?>" class="wpsp-form-control" id="Country" name="country">
        ...
        <div class="wpsp-card">
            ...
            <div class="wpsp-card-body">
                ...
                <div class="wpsp-btnsubmit-section">
                    <button type="submit" class="wpsp-btn wpsp-btn-success" id="teacherform"><?php echo esc_html("Submit","wpschoolpress");?></button>&nbsp;&nbsp;
                    <a href="<?php echo esc_url(wpsp_admin_url().'sch-teacher')?>" class="wpsp-btn wpsp-dark-btn"><?php echo esc_html("Back","wpschoolpress");?></a>
                </div>
            </div>
        </div>
    </div>

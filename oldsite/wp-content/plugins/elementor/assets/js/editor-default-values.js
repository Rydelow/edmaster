...
/***/ "../assets/dev/js/editor/components/documents/ui-states/preview-loading.js":
/*!*********************************************************************************!*\
  !*** ../assets/dev/js/editor/components/documents/ui-states/preview-loading.js ***!
  \*********************************************************************************/
...
exports["default"] = exports.PreviewLoading = void 0;
...
var PreviewLoading = /*#__PURE__*/function (_UiStateBase) {
  (0, _inherits2.default)(PreviewLoading, _UiStateBase);

  var _super = (0, _createSuper2.default)(PreviewLoading);

  function PreviewLoading() {
    var _this;

    (0, _classCallCheck2.default)(this, PreviewLoading);
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "timeout", 600);
    return _this;
  }

  (0, _createClass2.default)(PreviewLoading, [{
    key: "getId",
...
exports.PreviewLoading = PreviewLoading;
(0, _defineProperty2.default)(PreviewLoading, "ON", 'on');
var _default = PreviewLoading;
exports["default"] = _default;

/***/ }),

/***/ "../assets/dev/js/utils/pipe.js":
/*!**************************************!*\
  !*** ../assets/dev/js/utils/pipe.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "../modules/default-values/assets/js/editor/commands-data/index.js":
/*!*************************************************************************!*\
  !*** ../modules/default-values/assets/js/editor/commands-data/index.js ***!
  \*************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "../modules/default-values/assets/js/editor/commands/base.js":
/*!*******************************************************************!*\
  !*** ../modules/default-values/assets/js/editor/commands/base.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var _pipe = _interopRequireDefault(__webpack_require__(/*! elementor-utils/pipe */ "../assets/dev/js/utils/pipe.js"));

var _previewLoading = _interopRequireDefault(__webpack_require__(/*! elementor-editor/components/documents/ui-states/preview-loading */ "../assets/dev/js/editor/components/documents/ui-states/preview-loading.js"));
...
var Base = /*#__PURE__*/function (_$e$modules$CommandBa) {
  ...
  (0, _createClass2.default)(Base, [{
     ...
     */
    function () {
      var _recreateElements = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(type) {
        var newSettings,
            elementsToRecreate,
            _args = arguments;
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                newSettings = _args.length > 1 && _args[1] !== undefined ? _args[1] : {};
                // Get all the elements that should recreate (e.g: type = 'heading' it will recreate all the heading)
                elementsToRecreate = this.getElementsForRecreate(type, newSettings); // Fetch new widget config

                _context.next = 4;
                return this.refreshWidgetsConfig(type);

              case 4:
                _context.next = 6;
                return $e.commandsInternal.run('document/elements/recreate', {
                  models: elementsToRecreate
                });
      ...
      function recreateElements(_x) {
        return _recreateElements.apply(this, arguments);
      }

      return recreateElements;
    }()
    /**
    ...
    key: "getElementsForRecreate",
    value: function getElementsForRecreate(type, newDefaultSettings) {
      var _this = this;

      var elements = {};
      elementor.getPreviewContainer().children.forEachRecursive(function (element) {
    ...
    key: "refreshWidgetsConfig",
    value: function () {
      var _refreshWidgetsConfig = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(type) {
        var _yield$$e$data$get, widgetData;
        ...
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                _yield$$e$data$get = _context2.sent;
                widgetData = _yield$$e$data$get.data;
                elementor.addWidgetsCache((0, _defineProperty2.default)({}, type, widgetData)); // TODO: Maybe in the command?
      ...
      function refreshWidgetsConfig(_x2) {
        return _refreshWidgetsConfig.apply(this, arguments);
      }

      return refreshWidgetsConfig;
    }()
  }, {
    key: "startLoading",
    value: function startLoading() {
      $e.uiStates.set('editor/documents/preview-loading', _previewLoading.default.ON);
    }
  }, {
    key: "finishLoading",
...
/***/ "../modules/default-values/assets/js/editor/commands/create.js":
/*!*********************************************************************!*\
  !*** ../modules/default-values/assets/js/editor/commands/create.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var _base = _interopRequireDefault(__webpack_require__(/*! ./base */ "../modules/default-values/assets/js/editor/commands/base.js"));

var _pipe = _interopRequireDefault(__webpack_require__(/*! elementor-utils/pipe */ "../assets/dev/js/utils/pipe.js"));

var Create = /*#__PURE__*/function (_Base) {
  (0, _inherits2.default)(Create, _Base);
  ...
  (0, _createClass2.default)(Create, [{
    key: "validateArgs",
    value: function validateArgs(_ref) {
    ...
    key: "apply",
    value: function () {
      var _apply = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(_ref2) {
        var container, type, settings, _yield$$e$data$create, data;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                this.startLoading(); // e.g: heading, button, image.

                type = container.settings.get('widgetType'); // Get all the "styled" settings that differently from the hardcoded defaults.

                settings = this.getSettingsForSave(container); // Save those settings into default entity.

                _context.next = 6;
                return $e.data.create('default-values/index', {
                  settings: settings
                }, {
                  type: type
                });
              ...
              case 6:
                _yield$$e$data$create = _context.sent;
                data = _yield$$e$data$create.data;
                _context.next = 10;
                return this.recreateElements(type, data.settings);
...
/***/ "../modules/default-values/assets/js/editor/commands/index.js":
/*!********************************************************************!*\
  !*** ../modules/default-values/assets/js/editor/commands/index.js ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
_Object$defineProperty(exports, "Reset", {
  enumerable: true,
  get: function get() {
    return _reset.Reset;
  }
...
var _create = __webpack_require__(/*! ./create */ "../modules/default-values/assets/js/editor/commands/create.js");

var _reset = __webpack_require__(/*! ./reset */ "../modules/default-values/assets/js/editor/commands/reset.js");

/***/ }),

/***/ "../modules/default-values/assets/js/editor/commands/reset.js":
/*!********************************************************************!*\
  !*** ../modules/default-values/assets/js/editor/commands/reset.js ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var Reset = /*#__PURE__*/function (_Base) {
  (0, _inherits2.default)(Reset, _Base);

  var _super = (0, _createSuper2.default)(Reset);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                this.startLoading();
                _context.next = 4;
                return $e.data.delete('default-values/index', {
                  type: type
                });

              case 4:
                _context.next = 6;
                return this.recreateElements(type);
...
/***/ "../modules/default-values/assets/js/editor/component.js":
/*!***************************************************************!*\
  !*** ../modules/default-values/assets/js/editor/component.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var commands = _interopRequireWildcard(__webpack_require__(/*! ./commands/index */ "../modules/default-values/assets/js/editor/commands/index.js"));

var dataCommands = _interopRequireWildcard(__webpack_require__(/*! ./commands-data/index */ "../modules/default-values/assets/js/editor/commands-data/index.js"));
...
var _globalValues = _interopRequireDefault(__webpack_require__(/*! ./handlers/global-values */ "../modules/default-values/assets/js/editor/handlers/global-values.js"));

var _localValues = _interopRequireDefault(__webpack_require__(/*! ./handlers/local-values */ "../modules/default-values/assets/js/editor/handlers/local-values.js"));
...
var Component = /*#__PURE__*/function (_ComponentBase) {
  ...
  (0, _createClass2.default)(Component, [{
    ...
    value: function addContextMenuItem(groups, view) {
      return groups.map(function (group) {
        ...
        group.actions = [].concat((0, _toConsumableArray2.default)(group.actions), [{
          ...
          callback: function callback() {
            return $e.run('default-values/create', {
...
/***/ "../modules/default-values/assets/js/editor/handlers/base-handler.js":
/*!***************************************************************************!*\
  !*** ../modules/default-values/assets/js/editor/handlers/base-handler.js ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var BaseHandler = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(BaseHandler, [{
    key: "appendSettingsForSave",
    value: function appendSettingsForSave(settings, container) {
      return settings;
    }
  }, {
    key: "appendSettingsForRecreate",
    value: function appendSettingsForRecreate(element, container, newDefaultValues) {
      return element;
    }
  }]);
  return BaseHandler;
...
/***/ "../modules/default-values/assets/js/editor/handlers/global-values.js":
/*!****************************************************************************!*\
  !*** ../modules/default-values/assets/js/editor/handlers/global-values.js ***!
  \****************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var GlobalValues = /*#__PURE__*/function (_BaseHandler) {
  (0, _inherits2.default)(GlobalValues, _BaseHandler);
  ...
  (0, _createClass2.default)(GlobalValues, [{
    ...
    value: function appendSettingsForSave(settings, container) {
      ...
      var settingsKeys = (0, _keys.default)(settings); // When global is assign to control and it is the default value for the control
      // the values inside the control is empty, so it should also get all the default globals
      // and add them to the settings.

      var widgetGlobalDefaults = Object.fromEntries((0, _entries.default)(widgetControls).filter(function (_ref3) {
        var _control$global;

        var _ref4 = (0, _slicedToArray2.default)(_ref3, 2),
            control = _ref4[1];

        return (_control$global = control.global) === null || _control$global === void 0 ? void 0 : _control$global.default;
      }).filter(function (_ref5) {
        var _ref6 = (0, _slicedToArray2.default)(_ref5, 1),
            key = _ref6[0];

        return !settingsKeys.includes(key);
      }) // Removes all the values that override by local values
      .map(function (_ref7) {
        var _ref8 = (0, _slicedToArray2.default)(_ref7, 2),
            key = _ref8[0],
            control = _ref8[1];

        return [key, control.global.default];
      }));

      if (!(0, _keys.default)(widgetGlobalDefaults).length && !(0, _keys.default)(globalSettings).length) {
        return settings;
      }

      return (0, _objectSpread2.default)((0, _objectSpread2.default)({}, settings), {}, {
        __globals__: (0, _objectSpread2.default)((0, _objectSpread2.default)({}, widgetGlobalDefaults), globalSettings)
      });
    }
  }, {
    key: "appendSettingsForRecreate",
  ...
  return GlobalValues;
}(_baseHandler.default);

exports["default"] = GlobalValues;

/***/ }),

/***/ "../modules/default-values/assets/js/editor/handlers/local-values.js":
/*!***************************************************************************!*\
  !*** ../modules/default-values/assets/js/editor/handlers/local-values.js ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var LocalValues = /*#__PURE__*/function (_BaseHandler) {
  (0, _inherits2.default)(LocalValues, _BaseHandler);

  var _super = (0, _createSuper2.default)(LocalValues);

  function LocalValues() {
    (0, _classCallCheck2.default)(this, LocalValues);
    return _super.apply(this, arguments);
  }

  (0, _createClass2.default)(LocalValues, [{
    key: "appendSettingsForSave",
    value: function appendSettingsForSave(settings, container) {
      ...
      return (0, _objectSpread2.default)((0, _objectSpread2.default)({}, settings), Object.fromEntries(localSettings));
    }
  }, {
    key: "appendSettingsForRecreate",
    value: function appendSettingsForRecreate(element) {
      return element;
    }
  }]);
  return LocalValues;
...
"use strict";
/*!************************************************************!*\
  !*** ../modules/default-values/assets/js/editor/editor.js ***!
  \************************************************************/


var _interopRequireDefault = __webpack_require__(/*! @babel/runtime-corejs2/helpers/interopRequireDefault */ "../node_modules/@babel/runtime-corejs2/helpers/interopRequireDefault.js");

var _component = _interopRequireDefault(__webpack_require__(/*! ./component */ "../modules/default-values/assets/js/editor/component.js"));
...
/******/ })()
;
//# sourceMappingURL=editor-default-values.js.map
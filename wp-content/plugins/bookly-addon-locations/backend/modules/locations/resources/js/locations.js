jQuery(function($) {
    ...
    let
        ...
        elements             = {
            ...
            edit_btn: $('<button type="button" class="btn btn-defaulti" data-action="edit">').append($('<i class="far fa-fw fa-edit mr-lg-1" />'), '<span class="d-none d-lg-inline">' + BooklyL10n.edit + '…</span>').get(0).outerHTML
        },
        row
    ;
                ...
                columns.push({
                    ...
                    render: function (data, type, row, meta) {
                        if (data.length == 0) {
                            ...
                            return $.fn.dataTable.render.text().display(BooklyL10n.staff.collection[data[0]].full_name);
                        } else {

jQuery(function ($) {
    ...
    columns.push({
        ...
        width             : 90,
        render            : function (data, type, row, meta) {
            return '<button type="button" class="btn btn-default cust-edit-popup" data-action="edit" data-id="' + row.id + '"><i class="far fa-fw fa-edit mr-lg-1"></i><span class="d-none d-lg-inline">' + BooklyL10n.edit + '…</span></button>';
        }
    });
    columns.push({
        responsivePriority: 1,

...
if( $current_user_role=='administrator' || $current_user_role == 'parent'){?> <div class="wpsp-row "><?php } else { ?>
	...
	<div class="wpsp-row">
		...
		<div id="eventContent" title="Event Details" style="display:none;">
			...
			<h4><?php esc_html_e( 'Event Name', 'wpschoolpress' )?> :  <span id="viewEventTitle"></span></h4>
    	<?php esc_html_e( 'Start', 'wpschoolpress' );?>: <span id="eventStart"></span><br>
    	<?php esc_html_e( 'End', 'wpschoolpress' );?>: <span id="eventEnd"></span><br>

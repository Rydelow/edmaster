<p><?php esc_html_e('Hi there, you have been using Jitsi Meet WP for while now. Do you know that Jitsi Meet WP has an affiliate program?
    join now get 25% commission from each sale.', 'jitsi-meet-wp'); ?>
</p>
